...
This repository is a long-running attempt to study that contradiction, push on it, and make it visible.
...
Some pieces are ironic. Some deliberately challenge limits. Some provoke, but in good faith: not for shock alone, but to expose assumptions about what code is allowed to be, how it is supposed to behave, and where exactly we think the boundary of the medium lives.
...
I am interested in code not only as a tool, but as a surface for tension: between rigor and play, discipline and sabotage, elegance and discomfort. Irony matters here. So does misuse. So does the impulse to challenge limits just to understand why they exist in the first place.
...
- In many cases, the process of understanding how a piece works is part of the piece.
